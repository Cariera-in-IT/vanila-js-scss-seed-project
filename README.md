...
Make sure you have the Netlify CLI installed globally than in the terminal in the root directory enter these commands:  

1. `npm run netlify` - You will be promted to provide your credentials to Netlify and initialization.
2. `npm run netlify-deploy` - Deploy production to the associated netlify account website.
3. [optional] `npm run netlify-build` - Builds a local version of the website.

If you want to setup the project to update when you push to github with webhooks it is still possible.
